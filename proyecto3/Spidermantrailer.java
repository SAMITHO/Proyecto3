 ...
 * @author PC
 */
public class Spidermantrailer extends Application {

    @Override
    public void start(Stage stage) throws Exception {
        final String Nombre_archivo = "C:\\Users\\samue\\OneDrive\\Desktop\\Proyecto3\\src\\Peliculas y clips\\No way home\\Spider-Man_ Sin Camino a Casa _ Teaser Tráiler Oficial _ Marvel Studios.mp4";
    ...
    stage.setTitle("SpiderMan_Trailer");
    stage.show();
