 ...
 * @author PC
 */
public class strangetrailer extends Application {

    @Override
    public void start(Stage stage) throws Exception {
        final String Nombre_archivo = "C:\\Users\\samue\\OneDrive\\Desktop\\Proyecto3\\src\\Peliculas y clips\\Doctor Strange\\Doctor Strange en el Multiverso de la Locura _ Tráiler Oficial _ Doblado.mp4";
    ...
    stage.setTitle("DoctorStrange_Trailer");
    stage.show();
