 ...
 * @author PC
 */
public class Eraultron extends Application {

    @Override
    public void start(Stage stage) throws Exception {
        final String Nombre_archivo = "C:\\Users\\samue\\OneDrive\\Desktop\\Proyecto3\\src\\Peliculas y clips\\Avengers\\Avengers_ Era de Ultrón - Tráiler Oficial (Doblado al español).mp4";
    ...
    stage.setTitle("EraUltron_Trailer");
    stage.show();
