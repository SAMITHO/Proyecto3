 ...
 * @author PC
 */
public class capitanatrailer extends Application {

    @Override
    public void start(Stage stage) throws Exception {
        final String Nombre_archivo = "C:\\Users\\samue\\OneDrive\\Desktop\\Proyecto3\\src\\Peliculas y clips\\captain marvel\\Capitana Marvel, de Marvel Studios – Tráiler Oficial #1.mp4";
    ...
    stage.setTitle("Capitana_Trailer");
    stage.show();
