 ...
 * @author PC
 */
public class civilwartrailer extends Application {

    @Override
    public void start(Stage stage) throws Exception {
        final String Nombre_archivo = "C:\\Users\\samue\\OneDrive\\Desktop\\Proyecto3\\src\\Peliculas y clips\\Captain america\\Capitán América_ Civil War de Marvel _ Tráiler Oficial en español_ HD.mp4";
    ...
    Scene escena = new Scene(escenario, 1280,530 );
    stage.setScene(escena);
    stage.setTitle("CapitanAmerica_Trailer");
    stage.show();
