 ...
 * @author PC
 */
public class guardianstrailer extends Application {

    @Override
    public void start(Stage stage) throws Exception {
        final String Nombre_archivo = "C:\\Users\\samue\\OneDrive\\Desktop\\Proyecto3\\src\\Peliculas y clips\\Guardians of the galaxy\\Guardianes de la Galaxia Vol.2 - Nuevo Tráiler.mp4";
    ...
    stage.setTitle("Guardians_Trailer");
    stage.show();
